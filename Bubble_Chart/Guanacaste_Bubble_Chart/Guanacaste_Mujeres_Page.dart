...
class GuanacasteMujeresPage extends StatefulWidget {
  final Widget child;

  GuanacasteMujeresPage({Key key, this.child}) : super(key: key);

  _GuanacasteMujeresPageState createState() => _GuanacasteMujeresPageState();
}

class _GuanacasteMujeresPageState extends State<GuanacasteMujeresPage> {
  ...
  _generateData() {
    ...
    final OneHearData = [
      new HearData( 103, 0.04, 03.0, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData( 159, 0.06, 04.8, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData( 780, 0.29, 23.5, Color(0xff2f5496)),
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData( 173, 0.06, 05.0, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData( 477, 0.18, 15.0, Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a más años',
    final SixHearData = [
      new HearData( 974, 0.37, 30.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData( 241, 0.21, 20.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData( 184, 0.16, 16.0, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData( 354, 0.31, 30.0, Color(0xff2f5496)),
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData( 38, 0.03, 03.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData( 104, 0.09, 09.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a más años',
    final SixTalkData = [
      new TalkData( 214, 0.19, 18.0, Color(0xffdf6613)),
    ];
    ...
    final OneWalkData = [
      new WalkData( 211, 0.04, 04.0, Color(0xffac75d5)),
    ];

    /// TwoWalkData: all data for the case: De 15 a 29 años.
    final TwoWalkData = [
      new WalkData( 271, 0.05, 05.0, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData( 1756, 0.30, 28.0, Color(0xff2f5496)),
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData( 553, 0.09, 08.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData( 1206, 0.20, 19.0, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a más años',
    final SixWalkData = [
      new WalkData( 1904, 0.32, 30.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData( 94, 0.05, 04.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData( 112, 0.06, 05.0, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData( 734, 0.37, 30.0, Color(0xff2f5496)),
    ];

    /// FourArmData: all data for the case: De 60 a 64 años.
    final FourArmData = [
      new ArmData( 214, 0.11, 09.0, Color(0xff00b050)),
    ];

    /// FiveArmData: all data for the case: De 65 a 74 años.
    final FiveArmData = [
      new ArmData( 333, 0.17, 14.0, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a más años',
    final SixArmData = [
      new ArmData( 490, 0.25, 20.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData( 41010, 0.28, 23.0, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData( 42780, 0.29, 24.0, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData( 52710, 0.36, 30.0, Color(0xff2f5496)),
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData( 3639, 0.02, 02.0, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData( 4270, 0.03, 02.5, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a más años',
    final SixNoneData = [
      new NoneData( 2426, 0.02, 01.6, Color(0xffdf6613)),
    ];
