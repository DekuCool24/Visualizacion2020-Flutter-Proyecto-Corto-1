...
class GuanacasteHombresPage extends StatefulWidget {
  final Widget child;

  GuanacasteHombresPage({Key key, this.child}) : super(key: key);

  _GuanacasteHombresPageState createState() => _GuanacasteHombresPageState();
}

class _GuanacasteHombresPageState extends State<GuanacasteHombresPage> {
  ...
  _generateData() {
    ...
    final OneHearData = [
      new HearData( 133, 0.04, 03.4, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData( 205, 0.07, 06.0, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData( 806, 0.26, 22.0, Color(0xff2f5496)),
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData( 236, 0.08, 07.0, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData( 598, 0.20, 17.0, Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a más años',
    final SixHearData = [
      new HearData( 1078, 0.35, 30.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData( 487, 0.30, 30.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData( 283, 0.17, 17.0, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData( 474, 0.29, 29.0, Color(0xff2f5496)),
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData( 56, 0.03, 03.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData( 117, 0.07, 07.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a más años',
    final SixTalkData = [
      new TalkData( 223, 0.14, 14.0, Color(0xffdf6613)),
    ];
    ...
    final OneWalkData = [
      new WalkData( 238, 0.04, 03.4, Color(0xffac75d5)),
    ];

    /// TwoWalkData: all data for the case: De 15 a 29 años.
    final TwoWalkData = [
      new WalkData( 365, 0.07, 06.0, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData( 1946, 0.35, 30.0, Color(0xff2f5496)),
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData( 511, 0.09, 08.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData( 976, 0.18, 15.4, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a más años',
    final SixWalkData = [
      new WalkData( 1452, 0.26, 22.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData( 87, 0.05, 04.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData( 195, 0.10, 07.5, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData( 767, 0.40, 30.0, Color(0xff2f5496)),
    ];

    /// FourArmData: all data for the case: De 60 a 64 años.
    final FourArmData = [
      new ArmData( 173, 0.09, 07.0, Color(0xff00b050)),
    ];

    /// FiveArmData: all data for the case: De 65 a 74 años.
    final FiveArmData = [
      new ArmData( 305, 0.16, 12.0, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a más años',
    final SixArmData = [
      new ArmData( 379, 0.20, 15.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData( 42161, 0.29, 25.0, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData( 41474, 0.29, 24.8, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData( 50489, 0.35, 30.0, Color(0xff2f5496)),
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData( 3519, 0.02, 02.0, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData( 4494, 0.03, 03.0, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a más años',
    final SixNoneData = [
      new NoneData( 2334, 0.02, 01.7, Color(0xffdf6613)),
    ];
