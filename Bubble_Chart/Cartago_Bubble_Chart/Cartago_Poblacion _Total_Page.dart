...
class CartagoPoblacionTotalPage extends StatefulWidget {
  final Widget child;

  CartagoPoblacionTotalPage({Key key, this.child}) : super(key: key);

  _CartagoPoblacionTotalPageState createState() => _CartagoPoblacionTotalPageState();
}

class _CartagoPoblacionTotalPageState extends State<CartagoPoblacionTotalPage> {
  ...
  _generateData() {
    ...
    final OneHearData = [
      new HearData( 321, 0.05, 05.0, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData( 522, 0.07, 07.0, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData( 2184, 0.31, 29.0, Color(0xff2f5496)),
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData( 532, 0.08, 08.0, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData( 1272, 0.18, 17.0, Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a más.
    final SixHearData = [
      new HearData( 2243, 0.32, 30.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData( 656, 0.24, 24.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData( 415, 0.15, 15.0, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData( 824, 0.30, 30.0, Color(0xff2f5496)),
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData( 116, 0.04, 04.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData( 251, 0.09, 09.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a mas.
    final SixTalkData = [
      new TalkData( 523, 0.19, 19.0, Color(0xffdf6613)),
    ];
    ...
    final OneWalkData = [
      new WalkData( 478, 0.03, 03.0, Color(0xffac75d5)),
    ];

    /// TwoWalkData: all data for the case: De 15 a 29 años.
    final TwoWalkData = [
      new WalkData( 801, 0.05, 04.0, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData( 5085, 0.35, 30.0, Color(0xff2f5496)),
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData( 1499, 0.10, 09.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData( 2936, 0.20, 17.0, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a más.
    final SixWalkData = [
      new WalkData( 3818, 0.26, 22.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData( 239, 0.05, 04.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData( 438, 0.08, 06.0, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData( 2015, 0.38, 30.0, Color(0xff2f5496)),
    ];
    ...
    final FiveArmData = [
      new ArmData( 921, 0.18, 14.0, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a más.
    final SixArmData = [
      new ArmData( 1121, 0.21, 17.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData( 114711, 0.26, 21.0, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData( 131468, 0.29, 23.5, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData( 166688, 0.37, 30.0, Color(0xff2f5496)),
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData( 11412, 0.03, 03.0, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData( 14325, 0.03, 02.5, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a más.
    final SixNoneData = [
      new NoneData( 7387, 0.02, 02.0, Color(0xffdf6613)),
    ];
