...
class CartagoHombresPage extends StatefulWidget {
  final Widget child;

  CartagoHombresPage({Key key, this.child}) : super(key: key);

  _CartagoHombresPageState createState() => _CartagoHombresPageState();
}

class _CartagoHombresPageState extends State<CartagoHombresPage> {
  ...
  _generateData() {
    ...
    final OneHearData = [
      new HearData( 183, 0.05, 05.0, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData( 281, 0.08, 08.0, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData( 1126, 0.31, 30.0, Color(0xff2f5496)),
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData( 268, 0.07, 07.0, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData( 695, 0.19, 18.0,Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a más años',
    final SixHearData = [
      new HearData( 1079, 0.30, 29.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData( 246, 0.04, 03.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData( 443, 0.07, 06.0, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData( 2500, 0.38, 30.0, Color(0xff2f5496)),
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData( 674, 0.10, 08.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData( 1266, 0.19, 15.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a más años',
    final SixTalkData = [
      new TalkData( 1470, 0.22, 17.0, Color(0xffdf6613)),
    ];
    ...
    final OneWalkData = [
      new WalkData( 134, 0.06, 05.0, Color(0xffac75d5)),
    ];

    /// TwoWalkData: all data for the case: De 15 a 29 años.
    final TwoWalkData = [
      new WalkData( 270, 0.11, 09.0, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData( 960, 0.39, 30.0, Color(0xff2f5496)),
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData( 220, 0.09, 07.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData( 407, 0.17, 13.0, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a más años',
    final SixWalkData = [
      new WalkData( 441, 0.18, 14.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData( 668, 0.28, 25.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData( 801, 0.33, 30.0, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData( 719, 0.30, 27.0, Color(0xff2f5496)),
    ];

    /// FourArmData: all data for the case: De 60 a 64 años.
    final FourArmData = [
      new ArmData( 59, 0.02, 02.0, Color(0xff00b050)),
    ];

    /// FiveArmData: all data for the case: De 65 a 74 años.
    final FiveArmData = [
      new ArmData( 82, 0.03, 03.0, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a más años',
    final SixArmData = [
      new ArmData( 91, 0.04, 04.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData( 57930, 0.26, 22.0, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData( 65726, 0.30, 25.0, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData( 79757, 0.36, 30.0, Color(0xff2f5496)),
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData( 5401, 0.02, 02.0, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData( 6957, 0.03, 03.0, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a más años',
    final SixNoneData = [
      new NoneData( 3386, 0.02, 01.7, Color(0xffdf6613)),
    ];
