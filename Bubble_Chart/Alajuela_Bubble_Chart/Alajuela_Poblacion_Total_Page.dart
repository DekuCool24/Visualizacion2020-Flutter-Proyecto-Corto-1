...
class AlajuelaPoblacionTotalPage extends StatefulWidget {
  final Widget child;

  AlajuelaPoblacionTotalPage({Key key, this.child}) : super(key: key);

  _AlajuelaPoblacionTotalPageState createState() => _AlajuelaPoblacionTotalPageState();
}

class _AlajuelaPoblacionTotalPageState extends State<AlajuelaPoblacionTotalPage> {
  ...
  _generateData() {
    ...
    final OneHearData = [
      new HearData( 594, 0.04, 04.0, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData( 941, 0.07, 06.0, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData( 4024, 0.29, 26.0, Color(0xff2f5496)),
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData( 1080, 0.08, 07.0, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData( 2706, 0.19, 17.0, Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a más.
    final SixHearData = [
      new HearData( 4736, 0.34, 30.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData( 1429, 0.25, 27.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData( 969, 0.17, 18.0, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData( 1590, 0.28, 30.0, Color(0xff2f5496)),
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData( 202, 0.04, 04.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData( 491, 0.09, 10.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a mas.
    final SixTalkData = [
      new TalkData( 1057, 0.18, 19.0, Color(0xffdf6613)),
    ];
    ...
    final OneWalkData = [
      new WalkData( 956, 0.03, 03.0, Color(0xffac75d5)),
    ];

    /// TwoWalkData: all data for the case: De 15 a 29 años.
    final TwoWalkData = [
      new WalkData( 1677, 0.06, 05.0, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData( 9238, 0.34, 30.0, Color(0xff2f5496)),
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData( 2742, 0.08, 09.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData( 5364, 0.20, 18.0, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a más.
    final SixWalkData = [
      new WalkData( 7397, 0.27, 24.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData( 424, 0.04, 03.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData( 791, 0.08, 06.0, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData( 3813, 0.39, 30.0, Color(0xff2f5496)),
    ];

    /// FourArmData: all data for the case: De 60 a 64 años.
    final FourArmData = [
      new ArmData( 953, 0.10, 08.0, Color(0xff00b050)),
    ];

    /// FiveArmData: all data for the case: De 65 a 74 años.
    final FiveArmData = [
      new ArmData( 1726, 0.18, 14.0, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a más.
    final SixArmData = [
      new ArmData( 2060, 0.21, 17.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData( 208920, 0.27, 22.5, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData( 229405, 0.30, 25.0, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData( 272009, 0.36, 30.0, Color(0xff2f5496)),
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData( 18797, 0.02, 02.0, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData( 23303, 0.03, 03.0, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a más.
    final SixNoneData = [
      new NoneData( 11846, 0.02, 01.7, Color(0xffdf6613)),
    ];
