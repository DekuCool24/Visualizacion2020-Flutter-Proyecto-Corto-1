...
class CostaRicaHombresPage extends StatefulWidget {
  final Widget child;

  CostaRicaHombresPage({Key key, this.child}) : super(key: key);

  _CostaRicaHombresPageState createState() => _CostaRicaHombresPageState();
}

class _CostaRicaHombresPageState extends State<CostaRicaHombresPage> {
  ...
  _generateData() {
    ...
    final OneHearData = [
      new HearData(1844, 0.05, 05.0, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData(2705, 0.07, 07.0, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData(10727, 0.29, 27.0, Color(0xff2f5496))
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData(2963, 0.08, 08.0, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData(7145, 0.19, 18.0, Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a 89 años.
    final SixHearData = [
      new HearData(11856, 0.32, 30.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData(4748, 0.29, 30.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData(2870, 0.17, 18.0, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData(4633, 0.28, 29.0, Color(0xff2f5496))
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData(680, 0.04, 04.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData(1336, 0.08, 08.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a 89 años.
    final SixTalkData = [
      new TalkData(2328, 0.14, 14.0, Color(0xffdf6613)),
    ];
    ...
    final OneWalkData = [
      new WalkData(2523, 0.04, 03.0, Color(0xffac75d5)),
    ];

    /// TwoWalkData: all data for the case: De 15 a 29 años.
    final TwoWalkData = [
      new WalkData(4800, 0.07, 05.5, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData(24450, 0.38, 30.0, Color(0xff2f5496))
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData(6209, 0.10, 08.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData(11381, 0.18, 14.0, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a 89 años.
    final SixWalkData = [
      new WalkData(14908, 0.23, 18.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData(1228, 0.05, 04.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData(2465, 0.11, 05.7, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData(9601, 0.42, 30.0, Color(0xff2f5496))
    ];

    /// FourArmData: all data for the case: De 60 a 64 años.
    final FourArmData = [
      new ArmData(2179, 0.09, 06.0, Color(0xff00b050)),
    ];

    /// FiveArmData: all data for the case: De 65 a 74 años.
    final FiveArmData = [
      new ArmData(3537, 0.15, 11.0, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a 89 años.
    final SixArmData = [
      new ArmData(3991, 0.17, 16.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData(522484, 0.28, 23.0, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData(559775, 0.30, 25.0, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData(670212, 0.36, 30.0, Color(0xff2f5496)),
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData(47898, 0.03, 02.5, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData(58280, 0.03, 03.0, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a 89 años.
    final SixNoneData = [
      new NoneData(29019, 0.01, 02.0, Color(0xffdf6613)),
    ];
