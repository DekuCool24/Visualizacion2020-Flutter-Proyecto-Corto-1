///Costa_Rica_Poblacion_Total_Page
///
...
class CostaRicaPoblacionTotalPage extends StatefulWidget {
  final Widget child;

  CostaRicaPoblacionTotalPage({Key key, this.child}) : super(key: key);

  _CostaRicaPoblacionTotalPageState createState() => _CostaRicaPoblacionTotalPageState();
}

class _CostaRicaPoblacionTotalPageState extends State<CostaRicaPoblacionTotalPage> {
  ...
  _generateData() {
    ...
    final OneHearData = [
      new HearData(3339, 0.05, 04.5, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData(4983, 0.07, 06.0, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData(20643, 0.29, 26.0, Color(0xff2f5496))
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData(5409, 0.08, 07.0, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData(12858, 0.18, 16.0, Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a más años.
    final SixHearData = [
      new HearData(23477, 0.33, 30.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData(7331, 0.25, 27.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData(4810, 0.16, 17.0, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData(8359, 0.28, 30.0, Color(0xff2f5496))
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData(1210, 0.04, 04.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData(2469, 0.08, 09.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a más años.
    final SixTalkData = [
      new TalkData(5234, 0.18, 19.0, Color(0xffdf6613)),
    ];
    ...
    final OneWalkData = [
      new WalkData(4749, 0.03, 03.0, Color(0xffac75d5)),
    ];

    /// TwoWalkData: all data for the case: De 15 a 29 años.
    final TwoWalkData = [
      new WalkData(8350, 0.06, 05.0, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData(48919, 0.35, 30.0, Color(0xff2f5496)),
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData(13790, 0.10, 09.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData(26710, 0.19, 16.0, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a más años.
    final SixWalkData = [
      new WalkData(37862, 0.27, 23.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData(2202, 0.05, 04.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData(3953, 0.08, 06.0, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData(19530, 0.40, 30.0, Color(0xff2f5496))
    ];

    /// FourArmData: all data for the case: De 60 a 64 años.
    final FourArmData = [
      new ArmData(4766, 0.10, 08.0, Color(0xff00b050)),
    ];

    /// FiveArmData: all data for the case: De 65 a 74 años.
    final FiveArmData = [
      new ArmData(8216, 0.17, 13.0, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a más años.
    final SixArmData = [
      new ArmData(10192, 0.21, 16.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData(1031897, 0.27, 22.5, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData(1136145, 0.30, 25.0, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData(1396039, 0.36, 30.0, Color(0xff2f5496))
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData(100416, 0.03, 02.5, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData(120482, 0.03, 03.0, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a más años.
    final SixNoneData = [
      new NoneData(63884, 0.02, 02.0, Color(0xffdf6613)),
    ];
