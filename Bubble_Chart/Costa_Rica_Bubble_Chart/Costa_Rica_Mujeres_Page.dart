...
class CostaRicaMujeresPage extends StatefulWidget {
  final Widget child;

  CostaRicaMujeresPage({Key key, this.child}) : super(key: key);

  _CostaRicaMujeresPageState createState() => _CostaRicaMujeresPageState();
}

class _CostaRicaMujeresPageState extends State<CostaRicaMujeresPage> {
  ...
  _generateData() {
    ...
    final OneHearData = [
      new HearData(1495, 0.04, 04.0, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData(2278, 0.07, 06.0, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData(9916, 0.30, 26.0, Color(0xff2f5496)),
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData(2446, 0.07, 06.0, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData(5713, 0.17, 15.0, Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a 89 años.
    final SixHearData = [
      new HearData(11621, 0.35, 30.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData(2583, 0.20, 21.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData(1940, 0.15, 16.0, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData(3726, 0.29, 30.0, Color(0xff2f5496)),
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData(530, 0.04, 04.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData(1133, 0.09, 09.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a 89 años.
    final SixTalkData = [
      new TalkData(2906, 0.23, 24.0, Color(0xffdf6613)),
    ];
    ...
    final OneWalkData = [
      new WalkData(2226, 0.03, 03.0, Color(0xffac75d5)),
    ];

    /// TwoWalkData: all data for the case: De 15 a 29 años.
    final TwoWalkData = [
      new WalkData(3550, 0.05, 05.0, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData(24469, 0.32, 30.0, Color(0xff2f5496)),
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData(7581, 0.10, 09.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData(15329, 0.20, 19.0, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a 89 años.
    final SixWalkData = [
      new WalkData(22954, 0.30, 28.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData(974, 0.04, 03.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData(1488, 0.06, 05.0, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData(9929, 0.38, 30.0, Color(0xff2f5496)),
    ];

    /// FourArmData: all data for the case: De 60 a 64 años.
    final FourArmData = [
      new ArmData(2587, 0.10, 08.0, Color(0xff00b050)),
    ];

    /// FiveArmData: all data for the case: De 65 a 74 años.
    final FiveArmData = [
      new ArmData(4679, 0.18, 14.0, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a 89 años.
    final SixArmData = [
      new ArmData(6201, 0.24, 19.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData(509413, 0.26, 21.0, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData(576370, 0.29, 24.0, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData(725827, 0.37, 30.0, Color(0xff2f5496)),
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData(52518, 0.03, 02.0, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData(62202, 0.03, 02.4, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a 89 años.
    final SixNoneData = [
      new NoneData(34865, 0.02, 01.6, Color(0xffdf6613)),
    ];
