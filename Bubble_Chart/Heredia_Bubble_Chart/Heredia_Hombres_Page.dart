...
class HerediaHombresPage extends StatefulWidget {
  final Widget child;

  HerediaHombresPage({Key key, this.child}) : super(key: key);

  _HerediaHombresPageState createState() => _HerediaHombresPageState();
}

class _HerediaHombresPageState extends State<HerediaHombresPage> {
  ...
  _generateData() {
    ...
    final OneHearData = [
      new HearData( 135, 0.04, 04.0, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData( 272, 0.08, 09.0, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData( 929, 0.29, 28.0, Color(0xff2f5496)),
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData( 217, 0.07, 07.0, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData( 622, 0.20, 19.0, Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a más años',
    final SixHearData = [
      new HearData( 994, 0.31, 30.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData( 308, 0.24, 26.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData( 263, 0.21, 22.5, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData( 354, 0.28, 30.0, Color(0xff2f5496)),
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData( 62, 0.05, 05.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData( 121, 0.09, 10.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a más años',
    final SixTalkData = [
      new TalkData( 173, 0.14, 15.0, Color(0xffdf6613)),
    ];
    ...
    final OneWalkData = [
      new WalkData( 168, 0.03, 02.4, Color(0xffac75d5)),
    ];

    /// TwoWalkData: all data for the case: De 15 a 29 años.
    final TwoWalkData = [
      new WalkData( 452, 0.08, 06.0, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData( 2103, 0.38, 30.0, Color(0xff2f5496)),
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData( 516, 0.09, 07.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData( 942, 0.17, 13.0, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a más años',
    final SixWalkData = [
      new WalkData( 1287, 0.24, 19.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData( 82, 0.04, 03.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData( 236, 0.13, 09.0, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData( 788, 0.43, 30.0, Color(0xff2f5496)),
    ];

    /// FourArmData: all data for the case: De 60 a 64 años.
    final FourArmData = [
      new ArmData( 163, 0.09, 06.0, Color(0xff00b050)),
    ];

    /// FiveArmData: all data for the case: De 65 a 74 años.
    final FiveArmData = [
      new ArmData( 267, 0.15, 10.5, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a más años',
    final SixArmData = [
      new ArmData( 290, 0.16, 11.0, Color(0xffdf6613)),
    ];
    ...
    final SixMentalData = [
      new MentalData( 162, 0.12, 08.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData( 48711, 0.26, 20.5, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData( 56071, 0.29, 23.0, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData( 72007, 0.38, 30.0, Color(0xff2f5496)),
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData( 5143, 0.03, 02.4, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData( 5875, 0.03, 03.0, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a más años',
    final SixNoneData = [
      new NoneData( 2850, 0.01, 01.0, Color(0xffdf6613)),
    ];
