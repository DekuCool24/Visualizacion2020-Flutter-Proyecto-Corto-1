...
class SanJosePoblacionTotalPage extends StatefulWidget {
  final Widget child;

  SanJosePoblacionTotalPage({Key key, this.child}) : super(key: key);

  _SanJosePoblacionTotalPageState createState() => _SanJosePoblacionTotalPageState();
}

class _SanJosePoblacionTotalPageState extends State<SanJosePoblacionTotalPage> {
  ...
  _generateData() {
    ...
    final OneGlassesData = [
      new GlassesData( 5630, 0.06, 04.0, Color(0xffac75d5)),
    ];

    /// TwoGlassesData: all data for the case: De 15 a 29 años.
    final TwoGlassesData = [
      new GlassesData( 12812, 0.14, 09.0, Color(0xffff0066)),
    ];

    /// ThreeGlassesData: all data for the case: De 30 a 59 años.
    final ThreeGlassesData = [
      new GlassesData( 39827, 0.45, 30.0, Color(0xff2f5496)),
    ];

    /// FourGlassesData: all data for the case: De 60 a 64 años.
    final FourGlassesData = [
      new GlassesData( 7372, 0.08, 05.0, Color(0xff00b050)),
    ];

    /// FiveGlassesData: all data for the case: De 65 a 74 años.
    final FiveGlassesData = [
      new GlassesData( 11486, 0.13, 08.7, Color(0xffffbf00)),
    ];

    /// SixGlassesData: all data for the case: De 75 a mas.
    final SixGlassesData = [
      new GlassesData( 11594, 0.13, 09.0, Color(0xffdf6613)),
    ];
    ...
    final OneHearData = [
      new HearData( 1125, 0.05, 04.0, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData( 1647, 0.07, 06.0, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData( 6777, 0.28, 24.0, Color(0xff2f5496)),
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData( 1803, 0.08, 07.0, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData( 4106, 0.17, 15.0, Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a más.
    final SixHearData = [
      new HearData( 8324, 0.35, 30.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData( 2020, 0.22, 24.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData( 1410, 0.15, 16.0, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData( 2610, 0.28, 30.0, Color(0xff2f5496)),
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData( 447, 0.05, 05.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData( 808, 0.09, 10.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a mas.
    final SixTalkData = [
      new TalkData( 1874, 0.20, 21.0, Color(0xffdf6613)),
    ];
    ...
    final OneWalkData = [
      new WalkData( 1446, 0.03, 03.0, Color(0xffac75d5)),
    ];

    /// TwoWalkData: all data for the case: De 15 a 29 años.
    final TwoWalkData = [
      new WalkData( 2645, 0.06, 06.0, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData( 15551, 0.33, 30.0, Color(0xff2f5496)),
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData( 4348, 0.09, 08.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData( 8748, 0.19, 17.0, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a más.
    final SixWalkData = [
      new WalkData( 13795, 0.30, 27.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData( 717, 0.05, 04.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData( 1240, 0.08, 06.0, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData( 6047, 0.39, 30.0, Color(0xff2f5496)),
    ];

    /// FourArmData: all data for the case: De 60 a 64 años.
    final FourArmData = [
      new ArmData( 1465, 0.09, 07.0, Color(0xff00b050)),
    ];

    /// FiveArmData: all data for the case: De 65 a 74 años.
    final FiveArmData = [
      new ArmData( 2525, 0.16, 12.0, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a más.
    final SixArmData = [
      new ArmData( 3581, 0.23, 18.0, Color(0xffdf6613)),
    ];
    ...
    final OneIntellectualData = [
      new IntellectualData( 3007, 0.26, 24.0, Color(0xffac75d5)),
    ];

    /// TwoIntellectualData: all data for the case: De 15 a 29 años.
    final TwoIntellectualData = [
      new IntellectualData( 3700, 0.31, 29.0, Color(0xffff0066)),
    ];

    /// ThreeIntellectualData: all data for the case: De 30 a 59 años.
    final ThreeIntellectualData = [
      new IntellectualData( 3718, 0.32, 30.0, Color(0xff2f5496)),
    ];

    /// FourIntellectualData: all data for the case: De 60 a 64 años.
    final FourIntellectualData = [
      new IntellectualData( 276, 0.02, 02.0, Color(0xff00b050)),
    ];

    /// FiveIntellectualData: all data for the case: De 65 a 74 años.
    final FiveIntellectualData = [
      new IntellectualData( 427, 0.04, 04.0, Color(0xffffbf00)),
    ];

    /// SixIntellectualData: all data for the case: De 75 a más.
    final SixIntellectualData = [
      new IntellectualData( 637, 0.05, 05.0, Color(0xffdf6613)),
    ];
    ...
    final OneMentalData = [
      new MentalData( 916, 0.09, 07.0, Color(0xffac75d5)),
    ];

    /// TwoMentalData: all data for the case: De 15 a 29 años.
    final TwoMentalData = [
      new MentalData( 1771, 0.18, 13.0, Color(0xffff0066)),
    ];

    /// ThreeMentalData: all data for the case: De 30 a 59 años.
    final ThreeMentalData = [
      new MentalData( 4133, 0.41, 30.0, Color(0xff2f5496)),
    ];

    /// FourMentalData: all data for the case: De 60 a 64 años.
    final FourMentalData = [
      new MentalData( 575, 0.06, 04.0, Color(0xff00b050)),
    ];

    /// FiveMentalData: all data for the case: De 65 a 74 años.
    final FiveMentalData = [
      new MentalData( 878, 0.09, 06.0, Color(0xffffbf00)),
    ];

    /// SixMentalData: all data for the case: De 75 a más.
    final SixMentalData = [
      new MentalData( 1708, 0.17, 12.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData( 304827, 0.24, 19.0, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData( 367942, 0.29, 23.0, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData( 468341, 0.38, 30.0, Color(0xff2f5496)),
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData( 37591, 0.03, 02.0, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData( 44740, 0.04, 03.0, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a más.
    final SixNoneData = [
      new NoneData( 25152, 0.02, 01.6, Color(0xffdf6613)),
    ];
