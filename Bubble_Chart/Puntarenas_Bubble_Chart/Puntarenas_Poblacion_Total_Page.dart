///Puntarenas_Poblacion_Total_Page
///
...
class PuntarenasPoblacionTotalPage extends StatefulWidget {
  final Widget child;

  PuntarenasPoblacionTotalPage({Key key, this.child}) : super(key: key);

  _PuntarenasPoblacionTotalPageState createState() => _PuntarenasPoblacionTotalPageState();
}

class _PuntarenasPoblacionTotalPageState extends State<PuntarenasPoblacionTotalPage> {
  ...
  _generateData() {
    ...
    final OneHearData = [
      new HearData( 379, 0.05, 05.0, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData( 499, 0.07, 07.0, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData( 2259, 0.30, 29.0, Color(0xff2f5496)),
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData( 605, 0.08, 08.0, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData( 1447, 0.19, 18.0, Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a más.
    final SixHearData = [
      new HearData( 2375, 0.31, 30.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData( 967, 0.28, 30.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData( 602, 0.17, 18.0, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData( 976, 0.28, 30.0, Color(0xff2f5496)),
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData( 130, 0.04, 04.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData( 280, 0.08, 09.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a mas.
    final SixTalkData = [
      new TalkData( 537, 0.15, 16.0, Color(0xffdf6613)),
    ];
    ...
    final OneWalkData = [
      new WalkData( 579, 0.04, 03.0, Color(0xffac75d5)),
    ];

    /// TwoWalkData: all data for the case: De 15 a 29 años.
    final TwoWalkData = [
      new WalkData( 955, 0.06, 05.0, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData( 5641, 0.37, 30.0, Color(0xff2f5496)),
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData( 1528, 0.10, 08.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData( 2903, 0.19, 15.0, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a más.
    final SixWalkData = [
      new WalkData( 3551, 0.23, 19.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData( 228, 0.04, 03.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData( 422, 0.08, 06.0, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData( 2235, 0.41, 30.0, Color(0xff2f5496)),
    ];

    /// FourArmData: all data for the case: De 60 a 64 años.
    final FourArmData = [
      new ArmData( 608, 0.11, 08.0, Color(0xff00b050)),
    ];

    /// FiveArmData: all data for the case: De 65 a 74 años.
    final FiveArmData = [
      new ArmData( 936, 0.17, 12.0, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a más.
    final SixArmData = [
      new ArmData( 1008, 0.19, 14.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData( 111275, 0.31, 27.0, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData( 106687, 0.29, 26.0, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData( 124024, 0.34, 30.0, Color(0xff2f5496)),
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData( 8013, 0.02, 02.0, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData( 9724, 0.03, 03.0, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a más.
    final SixNoneData = [
      new NoneData( 4887, 0.01, 01.0, Color(0xffdf6613)),
    ];
