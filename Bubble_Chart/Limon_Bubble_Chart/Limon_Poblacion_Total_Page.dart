...
class LimonPoblacionTotalPage extends StatefulWidget {
  final Widget child;

  LimonPoblacionTotalPage({Key key, this.child}) : super(key: key);

  _LimonPoblacionTotalPageState createState() => _LimonPoblacionTotalPageState();
}

class _LimonPoblacionTotalPageState extends State<LimonPoblacionTotalPage> {
  ...
  _generateData() {
    ...
    final OneHearData = [
      new HearData( 427, 0.07, 06.0, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData( 546, 0.09, 08.0, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData( 2061, 0.32, 30.0, Color(0xff2f5496)),
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData( 554, 0.08, 08.4, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData( 1142, 0.18, 17.0, Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a más.
    final SixHearData = [
      new HearData( 1643, 0.26, 24.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData( 1006, 0.32, 30.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData( 553, 0.18, 17.0, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData( 867, 0.28, 26.25, Color(0xff2f5496)),
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData( 120, 0.04, 04.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData( 211, 0.07, 07.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a mas.
    final SixTalkData = [
      new TalkData( 369, 0.12, 11.0, Color(0xffdf6613)),
    ];
    ...
    final OneWalkData = [
      new WalkData( 506, 0.04, 03.0, Color(0xffac75d5)),
    ];

    /// TwoWalkData: all data for the case: De 15 a 29 años.
    final TwoWalkData = [
      new WalkData( 878, 0.07, 05.0, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData( 5454, 0.42, 30.0, Color(0xff2f5496)),
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData( 1466, 0.11, 08.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData( 2270, 0.17, 12.0, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a más.
    final SixWalkData = [
      new WalkData( 2440, 0.19, 14.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData( 251, 0.05, 03.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData( 412, 0.09, 06.0, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData( 2241, 0.46, 30.0, Color(0xff2f5496)),
    ];

    /// FourArmData: all data for the case: De 60 a 64 años.
    final FourArmData = [
      new ArmData( 478, 0.10, 06.5, Color(0xff00b050)),
    ];

    /// FiveArmData: all data for the case: De 65 a 74 años.
    final FiveArmData = [
      new ArmData( 771, 0.16, 10.0, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a más.
    final SixArmData = [
      new ArmData( 688, 0.14, 09.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData( 112907, 0.33, 30.0, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData( 102804, 0.30, 27.0, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData( 111016, 0.32, 29.0, Color(0xff2f5496)),
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData( 6472, 0.02, 01.8, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData(  7031, 0.02, 02.0, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a más.
    final SixNoneData = [
      new NoneData( 3341, 0.01, 01.0, Color(0xffdf6613)),
    ];
