...
class LimonHombresPage extends StatefulWidget {
  final Widget child;

  LimonHombresPage({Key key, this.child}) : super(key: key);

  _LimonHombresPageState createState() => _LimonHombresPageState();
}

class _LimonHombresPageState extends State<LimonHombresPage> {
  ...
  _generateData() {
    ...
    final OneHearData = [
      new HearData( 229, 0.06, 06.0, Color(0xffac75d5)),
    ];

    /// TwoHearData: all data for the case: De 15 a 29 años.
    final TwoHearData = [
      new HearData( 308, 0.09, 09.0, Color(0xffff0066)),
    ];

    /// ThreeHearData: all data for the case: De 30 a 59 años.
    final ThreeHearData = [
      new HearData( 1057, 0.29, 30.0, Color(0xff2f5496)),
    ];

    /// FourHearData: all data for the case: De 60 a 64 años.
    final FourHearData = [
      new HearData( 333, 0.09, 09.3, Color(0xff00b050)),
    ];

    /// FiveHearData: all data for the case: De 65 a 74 años.
    final FiveHearData = [
      new HearData( 688, 0.19, 18.0, Color(0xffffbf00)),
    ];

    /// SixHearData: all data for the case: De 75 a más años',
    final SixHearData = [
      new HearData( 975, 0.27, 28.0, Color(0xffdf6613)),
    ];
    ...
    final OneTalkData = [
      new TalkData( 659, 0.36, 30.0, Color(0xffac75d5)),
    ];

    /// TwoTalkData: all data for the case: De 15 a 29 años.
    final TwoTalkData = [
      new TalkData( 311, 0.17, 14.0, Color(0xffff0066)),
    ];

    /// ThreeTalkData: all data for the case: De 30 a 59 años.
    final ThreeTalkData = [
      new TalkData( 482, 0.26, 22.0, Color(0xff2f5496)),
    ];

    /// FourTalkData: all data for the case: De 60 a 64 años.
    final FourTalkData = [
      new TalkData( 69, 0.04, 03.0, Color(0xff00b050)),
    ];

    /// FiveTalkData: all data for the case: De 65 a 74 años.
    final FiveTalkData = [
      new TalkData( 121, 0.07, 06.0, Color(0xffffbf00)),
    ];

    /// SixTalkData: all data for the case: De 75 a más años',
    final SixTalkData = [
      new TalkData( 203, 0.11, 09.0, Color(0xffdf6613)),
    ];
    ...
    final TwoWalkData = [
      new WalkData( 507, 0.08, 06.0, Color(0xffff0066)),
    ];

    /// ThreeWalkData: all data for the case: De 30 a 59 años.
    final ThreeWalkData = [
      new WalkData( 2861, 0.42, 30.0, Color(0xff2f5496)),
    ];

    /// FourWalkData: all data for the case: De 60 a 64 años.
    final FourWalkData = [
      new WalkData( 747, 0.11, 08.0, Color(0xff00b050)),
    ];

    /// FiveWalkData: all data for the case: De 65 a 74 años.
    final FiveWalkData = [
      new WalkData( 1130, 0.17, 12.0, Color(0xffffbf00)),
    ];

    /// SixWalkData: all data for the case: De 75 a más años',
    final SixWalkData = [
      new WalkData( 1206, 0.18, 13.0, Color(0xffdf6613)),
    ];
    ...
    final OneArmData = [
      new ArmData( 143, 0.06, 04.0, Color(0xffac75d5)),
    ];

    /// TwoArmData: all data for the case: De 15 a 29 años.
    final TwoArmData = [
      new ArmData( 254, 0.10, 06.5, Color(0xffff0066)),
    ];

    /// ThreeArmData: all data for the case: De 30 a 59 años.
    final ThreeArmData = [
      new ArmData( 1173, 0.46, 30.0, Color(0xff2f5496)),
    ];

    /// FourArmData: all data for the case: De 60 a 64 años.
    final FourArmData = [
      new ArmData( 250, 0.10, 06.0, Color(0xff00b050)),
    ];

    /// FiveArmData: all data for the case: De 65 a 74 años.
    final FiveArmData = [
      new ArmData( 390, 0.15, 10.0, Color(0xffffbf00)),
    ];

    /// SixArmData: all data for the case: De 75 a más años',
    final SixArmData = [
      new ArmData( 342, 0.13, 09.0, Color(0xffdf6613)),
    ];
    ...
    final OneIntellectualData = [
      new IntellectualData( 485, 0.30, 26.0, Color(0xffac75d5)),
    ];
    ...
    final ThreeIntellectualData = [
      new IntellectualData( 464, 0.28, 25.0, Color(0xff2f5496)),
    ];
    ...
    final FiveIntellectualData = [
      new IntellectualData( 48, 0.03, 03.0, Color(0xffffbf00)),
    ];

    /// SixIntellectualData: all data for the case: De 75 a más años',
    final SixIntellectualData = [
      new IntellectualData( 48, 0.03, 03.0, Color(0xffdf6613)),
    ];
    ...
    final OneNoneData = [
      new NoneData( 57045, 0.33, 30.0, Color(0xffac75d5)),
    ];

    /// TwoNoneData: all data for the case: De 15 a 29 años.
    final TwoNoneData = [
      new NoneData( 50076, 0.29, 26.0, Color(0xffff0066)),
    ];

    /// ThreeNoneData: all data for the case: De 30 a 59 años.
    final ThreeNoneData = [
      new NoneData( 55190, 0.32, 29.0, Color(0xff2f5496)),
    ];

    /// FourNoneData: all data for the case: De 60 a 64 años.
    final FourNoneData = [
      new NoneData( 3472, 0.02, 01.8, Color(0xff00b050)),
    ];

    /// FiveNoneData: all data for the case: De 65 a 74 años.
    final FiveNoneData = [
      new NoneData( 3874, 0.02, 02.0, Color(0xffffbf00)),
    ];

    /// SixNoneData: all data for the case: De 75 a más años',
    final SixNoneData = [
      new NoneData( 1767, 0.01, 01.0, Color(0xffdf6613)),
    ];
