...
class SanJoseHombresParlamentChart extends StatelessWidget {
  ...
  SanJoseHombresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory SanJoseHombresParlamentChart.withSampleData() {
    return new SanJoseHombresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
