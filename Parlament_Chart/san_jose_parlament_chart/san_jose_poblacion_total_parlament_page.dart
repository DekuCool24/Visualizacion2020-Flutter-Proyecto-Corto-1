...
class SanJosePoblacionTotalParlamentChart extends StatelessWidget {
  ...
  SanJosePoblacionTotalParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory SanJosePoblacionTotalParlamentChart.withSampleData() {
    return new SanJosePoblacionTotalParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _glassesData() {
    final glasses = [
      ...
      new peopleData(45, Color(0xff2f5496), '30-59'),
      new peopleData(08, Color(0xff00b050), '60-64'),
      new peopleData(13, Color(0xffffbf00), '65-74'),
      new peopleData(13, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _hearData() {
    final hear = [
      ...
      new peopleData(35, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _talkData() {
    final talk = [
      new peopleData(22, Color(0xffac75d5), '0-14'),
      new peopleData(15, Color(0xffff0066), '15-29'),
      new peopleData(28, Color(0xff2f5496), '30-59'),
      new peopleData(05, Color(0xff00b050), '60-64'),
      new peopleData(09, Color(0xffffbf00), '65-74'),
      new peopleData(20, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _walkData() {
    final walk = [
      ...
      new peopleData(06, Color(0xffff0066), '15-29'),
      new peopleData(33, Color(0xff2f5496), '30-59'),
  ...
  static List<charts.Series<peopleData, String>> _armData() {
    final arm = [
      ...
      new peopleData(09, Color(0xff00b050), '60-64'),
      new peopleData(16, Color(0xffffbf00), '65-74'),
      new peopleData(23, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _intellectualData() {
    final intellectual = [
      ...
      new peopleData(31, Color(0xffff0066), '15-29'),
      new peopleData(32, Color(0xff2f5496), '30-59'),
      new peopleData(02, Color(0xff00b050), '60-64'),
      new peopleData(04, Color(0xffffbf00), '65-74'),
      new peopleData(05, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _mentalData() {
    final mental = [
      new peopleData(09, Color(0xffac75d5), '0-14'),
      new peopleData(18, Color(0xffff0066), '15-29'),
      new peopleData(41, Color(0xff2f5496), '30-59'),
      new peopleData(06, Color(0xff00b050), '60-64'),
      new peopleData(09, Color(0xffffbf00), '65-74'),
      new peopleData(17, Color(0xffdf6613), '75+'),
    ];
