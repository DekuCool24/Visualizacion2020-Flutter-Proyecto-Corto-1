...
class SanJoseMujeresParlamentChart extends StatelessWidget {
  ...
  SanJoseMujeresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory SanJoseMujeresParlamentChart.withSampleData() {
    return new SanJoseMujeresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _hearData() {
    final hear = [
      ...
      new peopleData(37, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _talkData() {
    final talk = [
      new peopleData(17, Color(0xffac75d5), '0-14'),
  ...
  static List<charts.Series<peopleData, String>> _walkData() {
    final walk = [
      new peopleData(02, Color(0xffac75d5), '0-14'),
  ...
  static List<charts.Series<peopleData, String>> _intellectualData() {
    final intellectual = [
      new peopleData(23, Color(0xffac75d5), '0-14'),
      ...
      new peopleData(08, Color(0xffdf6613), '75+'),
    ];
