...
class CostaRicaMujeresParlamentChart extends StatelessWidget {
  ...
  CostaRicaMujeresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory CostaRicaMujeresParlamentChart.withSampleData() {
    return new CostaRicaMujeresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _intellectualData() {
    final intellectual = [
      ...
      new peopleData(06, Color(0xffdf6613), '75+'),
    ];
