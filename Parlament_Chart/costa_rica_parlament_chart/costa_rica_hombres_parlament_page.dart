...
class CostaRicaHombresParlamentChart extends StatelessWidget {
  ...
  CostaRicaHombresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory CostaRicaHombresParlamentChart.withSampleData() {
    return new CostaRicaHombresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
