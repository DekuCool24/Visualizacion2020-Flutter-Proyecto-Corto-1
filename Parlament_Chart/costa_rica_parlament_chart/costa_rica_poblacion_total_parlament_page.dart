...
class CostaRicaPoblacionTotalParlamentChart extends StatelessWidget {
  ...
  CostaRicaPoblacionTotalParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory CostaRicaPoblacionTotalParlamentChart.withSampleData() {
    return new CostaRicaPoblacionTotalParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _glassesData() {
    final glasses = [
      ...
      new peopleData(14, Color(0xffffbf00), '65-74'),
  ...
  static List<charts.Series<peopleData, String>> _hearData() {
    final hear = [
      ...
      new peopleData(33, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _armData() {
    final arm = [
      ...
      new peopleData(40, Color(0xff2f5496), '30-59'),
      new peopleData(10, Color(0xff00b050), '60-64'),
  ...
  static List<charts.Series<peopleData, String>> _intellectualData() {
    final intellectual = [
      ...
      new peopleData(32, Color(0xffff0066), '15-29'),
