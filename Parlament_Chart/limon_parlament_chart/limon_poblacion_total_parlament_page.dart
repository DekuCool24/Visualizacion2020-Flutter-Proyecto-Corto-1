...
class LimonPoblacionTotalParlamentChart extends StatelessWidget {
  ...
  LimonPoblacionTotalParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory LimonPoblacionTotalParlamentChart.withSampleData() {
    return new LimonPoblacionTotalParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _glassesData() {
    final glasses = [
      ...
      new peopleData(10, Color(0xffff0066), '15-29'),
      new peopleData(52, Color(0xff2f5496), '30-59'),
      new peopleData(10, Color(0xff00b050), '60-64'),
      new peopleData(13, Color(0xffffbf00), '65-74'),
      new peopleData(10, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _walkData() {
    final walk = [
      ...
      new peopleData(11, Color(0xff00b050), '60-64'),
      new peopleData(17, Color(0xffffbf00), '65-74'),
      new peopleData(19, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _intellectualData() {
    final intellectual = [
      new peopleData(29, Color(0xffac75d5), '0-14'),
  ...
  static List<charts.Series<peopleData, String>> _mentalData() {
    final mental = [
      new peopleData(13, Color(0xffac75d5), '0-14'),
      new peopleData(23, Color(0xffff0066), '15-29'),
      new peopleData(44, Color(0xff2f5496), '30-59'),
      new peopleData(04, Color(0xff00b050), '60-64'),
      new peopleData(06, Color(0xffffbf00), '65-74'),
      new peopleData(09, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _noneData() {
    final none = [
      new peopleData(33, Color(0xffac75d5), '0-14'),
