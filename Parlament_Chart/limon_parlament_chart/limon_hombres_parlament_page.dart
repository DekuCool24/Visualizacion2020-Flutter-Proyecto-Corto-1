...
class LimonHombresParlamentChart extends StatelessWidget {
  ...
  LimonHombresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory LimonHombresParlamentChart.withSampleData() {
    return new LimonHombresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _talkData() {
    final talk = [
      new peopleData(36, Color(0xffac75d5), '0-14'),
  ...
  static List<charts.Series<peopleData, String>> _intellectualData() {
    final intellectual = [
      new peopleData(15, Color(0xffac75d5), '0-14'),
      new peopleData(24, Color(0xffff0066), '15-29'),
