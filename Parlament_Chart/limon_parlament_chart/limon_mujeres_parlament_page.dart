...
class LimonMujeresParlamentChart extends StatelessWidget {
  ...
  LimonMujeresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory LimonMujeresParlamentChart.withSampleData() {
    return new LimonMujeresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _glassesData() {
    final glasses = [
      ...
      new peopleData(54, Color(0xff2f5496), '30-59'),
  ...
  static List<charts.Series<peopleData, String>> _armData() {
    final arm = [
      ...
      new peopleData(47, Color(0xff2f5496), '30-59'),
  ...
  static List<charts.Series<peopleData, String>> _mentalData() {
    final mental = [
      new peopleData(12, Color(0xffac75d5), '0-14'),
