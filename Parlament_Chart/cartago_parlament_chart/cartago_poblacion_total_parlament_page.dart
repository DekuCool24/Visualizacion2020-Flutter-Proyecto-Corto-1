...
class CartagoPoblacionTotalParlamentChart extends StatelessWidget {
  ...
  CartagoPoblacionTotalParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory CartagoPoblacionTotalParlamentChart.withSampleData() {
    return new CartagoPoblacionTotalParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
