...
class CartagoMujeresParlamentChart extends StatelessWidget {
  ...
  CartagoMujeresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory CartagoMujeresParlamentChart.withSampleData() {
    return new CartagoMujeresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _hearData() {
    final hear = [
      ...
      new peopleData(34, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _talkData() {
    final talk = [
      new peopleData(20, Color(0xffac75d5), '0-14'),
      new peopleData(12, Color(0xffff0066), '15-29'),
  ...
  static List<charts.Series<peopleData, String>> _walkData() {
    final walk = [
      ...
      new peopleData(04, Color(0xffff0066), '15-29'),
      new peopleData(32, Color(0xff2f5496), '30-59'),
      new peopleData(10, Color(0xff00b050), '60-64'),
      new peopleData(21, Color(0xffffbf00), '65-74'),
      new peopleData(29, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _noneData() {
    final none = [
      new peopleData(25, Color(0xffac75d5), '0-14'),
