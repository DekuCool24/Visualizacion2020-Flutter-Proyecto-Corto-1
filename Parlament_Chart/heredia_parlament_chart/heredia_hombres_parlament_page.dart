...
class HerediaHombresParlamentChart extends StatelessWidget {
  ...
  HerediaHombresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory HerediaHombresParlamentChart.withSampleData() {
    return new HerediaHombresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
