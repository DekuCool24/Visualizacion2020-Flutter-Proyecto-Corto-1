...
class HerediaMujeresParlamentChart extends StatelessWidget {
  ...
  HerediaMujeresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory HerediaMujeresParlamentChart.withSampleData() {
    return new HerediaMujeresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _hearData() {
    final hear = [
      ...
      new peopleData(38, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _intellectualData() {
    final intellectual = [
      ...
      new peopleData(05, Color(0xffffbf00), '65-74'),
      new peopleData(07, Color(0xffdf6613), '75+'),
    ];
