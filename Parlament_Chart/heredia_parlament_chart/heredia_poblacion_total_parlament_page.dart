...
class HerediaPoblacionTotalParlamentChart extends StatelessWidget {
  ...
  HerediaPoblacionTotalParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory HerediaPoblacionTotalParlamentChart.withSampleData() {
    return new HerediaPoblacionTotalParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
