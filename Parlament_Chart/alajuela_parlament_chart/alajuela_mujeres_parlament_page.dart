...
class AlajuelaMujeresParlamentChart extends StatelessWidget {
  ...
  AlajuelaMujeresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory AlajuelaMujeresParlamentChart.withSampleData() {
    return new AlajuelaMujeresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
