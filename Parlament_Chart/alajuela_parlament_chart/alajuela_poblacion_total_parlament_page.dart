...
class AlajuelaPoblacionTotalParlamentChart extends StatelessWidget {
  ...
  AlajuelaPoblacionTotalParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory AlajuelaPoblacionTotalParlamentChart.withSampleData() {
    return new AlajuelaPoblacionTotalParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _mentalData() {
    final mental = [
      ...
      new peopleData(11, Color(0xffffbf00), '65-74'),
