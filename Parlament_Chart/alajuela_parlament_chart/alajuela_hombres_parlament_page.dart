...
class AlajuelaHombresParlamentChart extends StatelessWidget {
  ...
  AlajuelaHombresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory AlajuelaHombresParlamentChart.withSampleData() {
    return new AlajuelaHombresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _glassesData() {
    final glasses = [
      ...
      new peopleData(9, Color(0xff00b050), '60-64'),
