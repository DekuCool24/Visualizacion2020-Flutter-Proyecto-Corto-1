...
class PuntarenasHombresParlamentChart extends StatelessWidget {
  ...
  PuntarenasHombresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory PuntarenasHombresParlamentChart.withSampleData() {
    return new PuntarenasHombresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _hearData() {
    final hear = [
      ...
      new peopleData(32, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _talkData() {
    final talk = [
      ...
      new peopleData(26, Color(0xff2f5496), '30-59'),
  ...
  static List<charts.Series<peopleData, String>> _intellectualData() {
    final intellectual = [
      ...
      new peopleData(25, Color(0xffff0066), '15-29'),
