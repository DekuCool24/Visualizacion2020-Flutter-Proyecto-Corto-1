...
class PuntarenasPoblacionTotalParlamentChart extends StatelessWidget {
  ...
  PuntarenasPoblacionTotalParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory PuntarenasPoblacionTotalParlamentChart.withSampleData() {
    return new PuntarenasPoblacionTotalParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _glassesData() {
    final glasses = [
      ...
      new peopleData(49, Color(0xff2f5496), '30-59'),
  ...
  static List<charts.Series<peopleData, String>> _talkData() {
    final talk = [
      ...
      new peopleData(08, Color(0xffffbf00), '65-74'),
      new peopleData(15, Color(0xffdf6613), '75+'),
    ];
  ...
  static List<charts.Series<peopleData, String>> _walkData() {
    final walk = [
      ...
      new peopleData(37, Color(0xff2f5496), '30-59'),
      new peopleData(10, Color(0xff00b050), '60-64'),
      new peopleData(19, Color(0xffffbf00), '65-74'),
  ...
  static List<charts.Series<peopleData, String>> _intellectualData() {
    final intellectual = [
      new peopleData(30, Color(0xffac75d5), '0-14'),
      new peopleData(35, Color(0xffff0066), '15-29'),
      new peopleData(27, Color(0xff2f5496), '30-59'),
      new peopleData(01, Color(0xff00b050), '60-64'),
  ...
  static List<charts.Series<peopleData, String>> _mentalData() {
    final mental = [
      new peopleData(10, Color(0xffac75d5), '0-14'),
      new peopleData(19, Color(0xffff0066), '15-29'),
  ...
  static List<charts.Series<peopleData, String>> _noneData() {
    final none = [
      new peopleData(31, Color(0xffac75d5), '0-14'),
      new peopleData(29, Color(0xffff0066), '15-29'),
      new peopleData(34, Color(0xff2f5496), '30-59'),
