...
class PuntarenasMujeresParlamentChart extends StatelessWidget {
  ...
  PuntarenasMujeresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory PuntarenasMujeresParlamentChart.withSampleData() {
    return new PuntarenasMujeresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _glassesData() {
    final glasses = [
      ...
      new peopleData(51, Color(0xff2f5496), '30-59'),
