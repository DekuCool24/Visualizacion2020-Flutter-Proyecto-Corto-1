...
class GuanacasteHombresParlamentChart extends StatelessWidget {
  ...
  GuanacasteHombresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GuanacasteHombresParlamentChart.withSampleData() {
    return new GuanacasteHombresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
