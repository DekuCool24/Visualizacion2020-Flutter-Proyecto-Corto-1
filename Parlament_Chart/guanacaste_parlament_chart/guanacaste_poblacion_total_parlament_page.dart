...
class GuanacastePoblacionTotalParlamentChart extends StatelessWidget {
  ...
  GuanacastePoblacionTotalParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GuanacastePoblacionTotalParlamentChart.withSampleData() {
    return new GuanacastePoblacionTotalParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _hearData() {
    final hear = [
      ...
      new peopleData(36, Color(0xffdf6613), '75+'),
    ];
