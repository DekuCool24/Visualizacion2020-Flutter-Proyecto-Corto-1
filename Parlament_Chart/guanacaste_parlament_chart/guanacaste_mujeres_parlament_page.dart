...
class GuanacasteMujeresParlamentChart extends StatelessWidget {
  ...
  GuanacasteMujeresParlamentChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GuanacasteMujeresParlamentChart.withSampleData() {
    return new GuanacasteMujeresParlamentChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
  ...
  static List<charts.Series<peopleData, String>> _talkData() {
    final talk = [
      new peopleData(21, Color(0xffac75d5), '0-14'),
