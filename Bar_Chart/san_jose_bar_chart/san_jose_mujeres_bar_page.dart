...
class SanJoseMujeresBarChart extends StatelessWidget {
  ...
  SanJoseMujeresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory SanJoseMujeresBarChart.withSampleData() {
    return new SanJoseMujeresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
