...
class SanJoseHombresBarChart extends StatelessWidget {
  ...
  SanJoseHombresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory SanJoseHombresBarChart.withSampleData() {
    return new SanJoseHombresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
