...
class SanJosePoblacionTotalBarChart extends StatelessWidget {
  ...
  SanJosePoblacionTotalBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory SanJosePoblacionTotalBarChart.withSampleData() {
    return new SanJosePoblacionTotalBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
