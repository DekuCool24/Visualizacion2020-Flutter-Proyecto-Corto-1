...
class AlajuelaHombresBarChart extends StatelessWidget {
  ...
  AlajuelaHombresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory AlajuelaHombresBarChart.withSampleData() {
    return new AlajuelaHombresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
