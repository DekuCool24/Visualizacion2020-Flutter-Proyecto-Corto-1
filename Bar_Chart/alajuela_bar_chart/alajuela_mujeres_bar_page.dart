...
class AlajuelaMujeresBarChart extends StatelessWidget {
  ...
  AlajuelaMujeresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory AlajuelaMujeresBarChart.withSampleData() {
    return new AlajuelaMujeresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
