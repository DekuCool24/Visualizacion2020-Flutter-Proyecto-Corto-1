...
class AlajuelaPoblacionTotalBarChart extends StatelessWidget {
  ...
  AlajuelaPoblacionTotalBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory AlajuelaPoblacionTotalBarChart.withSampleData() {
    return new AlajuelaPoblacionTotalBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
