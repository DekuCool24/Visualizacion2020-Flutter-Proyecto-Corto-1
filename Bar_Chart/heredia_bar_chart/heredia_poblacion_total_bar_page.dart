...
class HerediaPoblacionTotalBarChart extends StatelessWidget {
  ...
  HerediaPoblacionTotalBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory HerediaPoblacionTotalBarChart.withSampleData() {
    return new HerediaPoblacionTotalBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
