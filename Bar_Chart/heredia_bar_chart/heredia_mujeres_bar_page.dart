...
class HerediaMujeresBarChart extends StatelessWidget {
  ...
  HerediaMujeresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory HerediaMujeresBarChart.withSampleData() {
    return new HerediaMujeresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
