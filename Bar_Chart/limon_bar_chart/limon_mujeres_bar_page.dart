...
class LimonMujeresBarChart extends StatelessWidget {
  ...
  LimonMujeresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory LimonMujeresBarChart.withSampleData() {
    return new LimonMujeresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
