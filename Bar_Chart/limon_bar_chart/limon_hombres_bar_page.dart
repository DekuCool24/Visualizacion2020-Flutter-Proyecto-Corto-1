...
class LimonHombresBarChart extends StatelessWidget {
  ...
  LimonHombresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory LimonHombresBarChart.withSampleData() {
    return new LimonHombresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
