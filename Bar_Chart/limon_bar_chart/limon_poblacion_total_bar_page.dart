...
class LimonPoblacionTotalBarChart extends StatelessWidget {
  ...
  LimonPoblacionTotalBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory LimonPoblacionTotalBarChart.withSampleData() {
    return new LimonPoblacionTotalBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
