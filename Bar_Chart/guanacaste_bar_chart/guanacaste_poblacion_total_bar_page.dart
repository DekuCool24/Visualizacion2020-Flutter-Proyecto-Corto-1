...
class GuanacastePoblacionTotalBarChart extends StatelessWidget {
  ...
  GuanacastePoblacionTotalBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GuanacastePoblacionTotalBarChart.withSampleData() {
    return new GuanacastePoblacionTotalBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
