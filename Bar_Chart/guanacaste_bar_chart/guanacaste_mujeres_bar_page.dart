...
class GuanacasteMujeresBarChart extends StatelessWidget {
  ...
  GuanacasteMujeresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GuanacasteMujeresBarChart.withSampleData() {
    return new GuanacasteMujeresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
