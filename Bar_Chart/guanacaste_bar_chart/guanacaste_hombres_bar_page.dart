...
class GuanacasteHombresBarChart extends StatelessWidget {
  ...
  GuanacasteHombresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GuanacasteHombresBarChart.withSampleData() {
    return new GuanacasteHombresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
