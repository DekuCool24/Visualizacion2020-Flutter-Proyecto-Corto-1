...
class PuntarenasHombresBarChart extends StatelessWidget {
  ...
  PuntarenasHombresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory PuntarenasHombresBarChart.withSampleData() {
    return new PuntarenasHombresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
