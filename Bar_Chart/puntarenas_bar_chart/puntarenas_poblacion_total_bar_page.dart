...
class PuntarenasPoblacionTotalBarChart extends StatelessWidget {
  ...
  PuntarenasPoblacionTotalBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory PuntarenasPoblacionTotalBarChart.withSampleData() {
    return new PuntarenasPoblacionTotalBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
