...
class PuntarenasMujeresBarChart extends StatelessWidget {
  ...
  PuntarenasMujeresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory PuntarenasMujeresBarChart.withSampleData() {
    return new PuntarenasMujeresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
