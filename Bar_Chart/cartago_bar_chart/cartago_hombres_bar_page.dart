...
class CartagoHombresBarChart extends StatelessWidget {
  ...
  CartagoHombresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory CartagoHombresBarChart.withSampleData() {
    return new CartagoHombresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
