...
class CartagoPoblacionTotalBarChart extends StatelessWidget {
  ...
  CartagoPoblacionTotalBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory CartagoPoblacionTotalBarChart.withSampleData() {
    return new CartagoPoblacionTotalBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
