...
class CartagoMujeresBarChart extends StatelessWidget {
  ...
  CartagoMujeresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory CartagoMujeresBarChart.withSampleData() {
    return new CartagoMujeresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
