...
class CostaRicaHombresBarChart extends StatelessWidget {
  ...
  CostaRicaHombresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory CostaRicaHombresBarChart.withSampleData() {
    return new CostaRicaHombresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
