...
class CostaRicaMujeresBarChart extends StatelessWidget {
  ...
  CostaRicaMujeresBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory CostaRicaMujeresBarChart.withSampleData() {
    return new CostaRicaMujeresBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
