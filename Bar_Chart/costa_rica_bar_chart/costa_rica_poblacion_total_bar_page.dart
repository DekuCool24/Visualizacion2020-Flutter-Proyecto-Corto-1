...
class CostaRicaPoblacionTotalBarChart extends StatelessWidget {
  ...
  CostaRicaPoblacionTotalBarChart(this.glassesList, this.hearList, this.talkList,
      this.walkList, this.armList, this.intellectualList,
      this.mentalList, this.noneList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory CostaRicaPoblacionTotalBarChart.withSampleData() {
    return new CostaRicaPoblacionTotalBarChart(
      _glassesData(),
      _hearData(),
      _talkData(),
      _walkData(),
